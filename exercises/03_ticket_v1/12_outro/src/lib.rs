...
// tests can't access private or `pub(crate)`ß items.

//* We don't wrap this in a module since the tests reference from the project's name */
pub struct Order {
    product_name: String,
    quantity: u32,
    unit_price: u32,
