/*
* we've made the struct and its "new" method public, but not the fields themselves.
* That way you have to use new to create a new ticket, and the fields will be validated.
*/
